...
For a new audit, call `start_audit` with the user's site and response language. For a request to resume or find an audit, call `list_audits`. Do not reproduce the catalog from memory or begin an informal parallel checklist.
