...
Готовые ZIP-пакеты версии 0.1.0 опубликованы в [GitHub Releases](https://github.com/aktaumag/seo-audit-agent-plugin/releases/tag/v0.1.0).
...
Подробные инструкции будут доступны на публичном сайте SEO Audit Agent после завершения клиентских проверок.
